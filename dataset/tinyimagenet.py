...
def get_test_loader(dataset='tinyimagenet', batch_size=128, num_workers=8):
...
def get_tinyimagenet_dataloaders_sample(dataset='tinyimagenet', batch_size=128, num_workers=8,
    ...
    # dataset
    train_dataset = ImageFolderSample(train_folder, transform=train_transforms, is_sample=is_sample, k=k)

    val_dataset = datasets.ImageFolder(test_folder, transform=val_transforms)
    ...
    test_loader = DataLoader(val_dataset,
                             ...
                             pin_memory=True,
                             sampler=val_sampler)
    print('num_samples', len(train_dataset.samples))
    print('num_class', len(val_dataset.classes))

    return train_loader, test_loader, len(train_dataset), len(train_dataset.classes), train_sampler
